...
INCPATH       = -I. -I. -I/usr/include/qt -I/usr/include/qt/QtBluetooth -I/usr/include/qt/QtCore -I. -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
DISTDIR = /tmp/letssee/DesktopANCS/.tmp/DesktopANCS1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath-link,/usr/lib
LIBS          = $(SUBLIBS) /usr/lib/libQt5Bluetooth.so /usr/lib/libQt5Core.so -lpthread
AR            = ar cqs
RANLIB        =
SED           = sed
STRIP         = strip
...
moc_ancs.cpp: ancs.h \
		...
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /tmp/letssee/DesktopANCS/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/tmp/letssee/DesktopANCS -I/tmp/letssee/DesktopANCS -I/usr/include/qt -I/usr/include/qt/QtBluetooth -I/usr/include/qt/QtCore -I/usr/include/c++/10.2.0 -I/usr/include/c++/10.2.0/x86_64-pc-linux-gnu -I/usr/include/c++/10.2.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/10.2.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/10.2.0/include-fixed -I/usr/include ancs.h -o moc_ancs.cpp
...
le_controller.o: le_controller.cpp le_controller.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o le_controller.o le_controller.cpp
